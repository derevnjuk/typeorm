...
export class InsertQueryBuilder<Entity> extends QueryBuilder<Entity> {
    ...
    protected getInsertedColumns(): ColumnMetadata[] {
        ...
        return this.expressionMap.mainAlias!.metadata.columns.filter(column => {
            ...
            return !(column.isGenerated && column.generationStrategy === "increment" && !(this.connection.driver instanceof OracleDriver) && !(this.connection.driver instanceof MysqlDriver));
